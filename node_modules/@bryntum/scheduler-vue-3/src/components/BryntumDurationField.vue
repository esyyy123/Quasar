...
import type { AlignSpec, Base, ContainerItemConfig, Duration, DurationConfig, DurationFieldListeners, DurationUnit, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
