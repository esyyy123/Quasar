import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, FileFieldListeners, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
