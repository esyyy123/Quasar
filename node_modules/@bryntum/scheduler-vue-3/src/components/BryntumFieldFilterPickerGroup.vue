...
import { FieldFilterPickerGroup } from '@bryntum/scheduler';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Core/widget/FieldFilterPickerGroup#config-ariaLive)
     */
    ariaLive ? : string
    /**
