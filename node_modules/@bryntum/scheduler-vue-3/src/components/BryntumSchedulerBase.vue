<!-- Vue 3 wrapper for Bryntum SchedulerBase -->
...
import type { AjaxStore, AjaxStoreConfig, AssignmentModel, AssignmentModelConfig, AssignmentStore, AssignmentStoreConfig, Base, CellCopyPaste, CellCopyPasteConfig, CellEdit, CellEditConfig, CellMenu, CellMenuConfig, CellTooltip, CellTooltipConfig, Column, ColumnAutoWidth, ColumnAutoWidthConfig, ColumnDragToolbar, ColumnDragToolbarConfig, ColumnLines, ColumnLinesConfig, ColumnPicker, ColumnPickerConfig, ColumnRename, ColumnRenameConfig, ColumnReorder, ColumnReorderConfig, ColumnResize, ColumnResizeConfig, ColumnStore, ColumnStoreConfig, Container, ContainerItemConfig, CrudManager, CrudManagerConfig, DateConstraint, Dependencies, DependenciesConfig, DependencyBaseModel, DependencyEdit, DependencyEditConfig, DependencyModel, DependencyModelConfig, DependencyStore, DependencyStoreConfig, DomClassList, DomConfig, DropData, DurationConfig, DurationUnit, Editor, EventColor, EventCopyPaste, EventCopyPasteConfig, EventDrag, EventDragConfig, EventDragCreate, EventDragCreateConfig, EventDragSelect, EventDragSelectConfig, EventEdit, EventEditConfig, EventFilter, EventFilterConfig, EventMenu, EventMenuConfig, EventModel, EventModelConfig, EventNonWorkingTime, EventNonWorkingTimeConfig, EventResize, EventResizeConfig, EventResizeData, EventStore, EventStoreConfig, EventTooltip, EventTooltipConfig, ExcelExporter, ExcelExporterConfig, ExportConfig, Field, FileDrop, FileDropConfig, FillHandle, FillHandleConfig, Filter, FilterBar, FilterBarConfig, FilterConfig, Grid, GridBase, GridColumnConfig, GridLocation, GridLocationConfig, GridSelectionMode, Group, GroupConfig, GroupSummary, GroupSummaryConfig, HeaderMenu, HeaderMenuConfig, HeaderZoom, HeaderZoomConfig, Labels, LabelsConfig, LockRows, LockRowsConfig, Mask, MaskConfig, Menu, MenuItem, MenuItemConfig, MergeCells, MergeCellsConfig, Model, ModelConfig, NonWorkingTime, NonWorkingTimeConfig, PagingToolbarConfig, Pan, PanConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, PdfExport, PdfExportConfig, Popup, PreserveScrollOptions, Print, PrintConfig, ProjectModel, ProjectModelConfig, QuickFind, QuickFindConfig, RecordPositionContext, RegionResize, RegionResizeConfig, ResourceHeaderConfig, ResourceMarginConfig, ResourceMenu, ResourceMenuConfig, ResourceModel, ResourceModelConfig, ResourceStore, ResourceStoreConfig, ResourceTimeRangeModel, ResourceTimeRangeModelConfig, ResourceTimeRangeStore, ResourceTimeRangeStoreConfig, ResourceTimeRanges, ResourceTimeRangesConfig, Row, RowCopyPaste, RowCopyPasteConfig, RowExpander, RowExpanderConfig, RowReorder, RowReorderConfig, RowResize, RowResizeConfig, ScheduleContext, ScheduleContextConfig, ScheduleMenu, ScheduleMenuConfig, ScheduleTooltip, ScheduleTooltipConfig, Scheduler, SchedulerBaseListeners, ScrollButtons, ScrollButtonsConfig, ScrollManager, ScrollManagerConfig, Scroller, ScrollerConfig, Search, SearchConfig, SimpleEventEdit, SimpleEventEditConfig, Sort, SortConfig, Split, SplitConfig, StateProvider, StickyCells, StickyCellsConfig, StickyEvents, StickyEventsConfig, Store, StoreConfig, Stripe, StripeConfig, SubGrid, SubGridConfig, Summary, SummaryConfig, TabConfig, TimeAxis, TimeAxisColumn, TimeAxisConfig, TimeAxisHeaderMenu, TimeAxisHeaderMenuConfig, TimeRanges, TimeRangesConfig, TimeSelection, TimeSelectionConfig, TimeSpan, TimeSpanConfig, TimelineBase, TimelineContext, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Tree, TreeConfig, TreeGroup, TreeGroupConfig, VerticalTimeAxisColumn, VerticalTimeAxisColumnConfig, ViewPreset, ViewPresetConfig, VisibleDate, Widget } from '@bryntum/scheduler';
import { SchedulerBase } from '@bryntum/scheduler';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Scheduler/view/SchedulerBase#config-ariaLive)
     */
    ariaLive ? : string
    /**
     ...
     * read only mode).
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Scheduler/view/SchedulerBase#config-createEventOnDblClick)
    ...
    date ? : Date
    /**
     * A [DateHelper](https://bryntum.com/products/scheduler/docs/api/Core/helper/DateHelper) format string to use to create date output for view descriptions.
     */
    dateFormat ? : string
    /**
    ...
    /**
     * Text or HTML, or a [DomConfig](https://bryntum.com/products/scheduler/docs/api/Core/helper/DomHelper#typedef-DomConfig) block to display when there is no data to display in the grid
     */
     ...
     */
    eventRenderer ? : (detail: { eventRecord: EventModel, resourceRecord: ResourceModel, assignmentRecord: AssignmentModel, scheduler: Scheduler, renderData: { event: EventModel, cls: DomClassList|string, wrapperCls: DomClassList|string, iconCls: DomClassList|string, left: number, width: number, height: number, style: string|Record<string, string>, wrapperStyle: string|Record<string, string>, eventStyle: string, eventColor: string, children: DomConfig[] } }) => string|DomConfig|DomConfig[]
    /**
    ...
    /**
     * Scheduler overrides Grids default implementation of [getRowHeight](https://bryntum.com/products/scheduler/docs/api/Grid/view/GridBase#config-getRowHeight) to
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Scheduler/view/SchedulerBase#config-stepUnit)
     */
    ...
    /**
     * Feature that displays a text field to edit the event name. You can control the flow of this by listening to the events relayed by this class from the underlying [Editor](https://bryntum.com/products/scheduler/docs/api/Core/widget/Editor).
...
const emit = defineEmits<{
     ...
     * @param {DependencyModel} params.event.dependencyRecord The dependency about to be saved
     */
    (e: 'afterDependencySave', params: ((event: { source: Scheduler, dependencyRecord: DependencyModel }) => void)|string): void
    /**
     ...
     * @param {EventModel} params.event.eventRecord The event record being created
     * @param {ResourceModel} params.event.resourceRecord The resource record
     * @param {HTMLElement} params.event.eventElement The element representing the created event record
     */
    (e: 'afterDragCreate', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, eventElement: HTMLElement }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source
     * @param {AssignmentModel[]} params.event.assignmentRecords
     * @param {EventModel[]} params.event.eventRecords
     * @param {boolean} params.event.valid
     * @param {object} params.event.context
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'afterEventDrop', params: ((event: { source: Scheduler, assignmentRecords: AssignmentModel[], eventRecords: EventModel[], valid: boolean, context: object, domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {EventModel} params.event.eventRecord The record about to be saved
     */
     ...
     * @param {AssignmentModel[]} params.event.selected An array of the Assignments added to the selection.
     * @param {AssignmentModel[]} params.event.deselected An array of the Assignments removed from the selection.
     * @param {AssignmentModel[]} params.event.selection The new selection.
     */
    (e: 'assignmentSelectionChange', params: ((event: { action: 'select'|'deselect'|'update'|'clear', selected: AssignmentModel[], deselected: AssignmentModel[], selection: AssignmentModel[] }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source The Scheduler instance
     * @param {EventModel[]} params.event.eventRecords The records about to be deleted
     ...
     */
    (e: 'beforeAssignmentDelete', params: ((event: { source: Scheduler, eventRecords: EventModel[], context: { finalize: { removeRecords?: boolean } } }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {EventModel[]} params.event.selected An array of assignments that will be added to the selection.
     * @param {EventModel[]} params.event.deselected An array of assignments that will be removed from the selection.
     * @param {EventModel[]} params.event.selection The currently selected assignments, before applying `selected` and `deselected`.
     */
    (e: 'beforeAssignmentSelectionChange', params: ((event: { action: string, selected: EventModel[], deselected: EventModel[], selection: EventModel[] }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {Field} params.event.editorContext.editor The input field that the column is configured with (see [field](https://bryntum.com/products/scheduler/docs/api/Grid/column/Column#config-field)). This property mey be replaced to be a different [field](https://bryntum.com/products/scheduler/docs/api/Core/widget/Field) in the handler, to take effect just for the impending edit.
     ...
     * @param {DependencyEdit} params.event.dependencyEdit The dependency edit feature
     * @param {DependencyModel} params.event.dependencyRecord The dependency about to be added
     */
    (e: 'beforeDependencyAdd', params: ((event: { source: Scheduler, dependencyEdit: DependencyEdit, dependencyRecord: DependencyModel }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source The scheduler instance
     * @param {DependencyModel} params.event.dependencyRecord The dependency record about to be deleted
     */
    (e: 'beforeDependencyDelete', params: ((event: { source: Scheduler, dependencyRecord: DependencyModel }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source The scheduler or Gantt instance
     * @param {DependencyEdit} params.event.dependencyEdit The dependencyEdit feature
     * @param {DependencyModel} params.event.dependencyRecord The record about to be shown in the editor.
     */
    (e: 'beforeDependencyEdit', params: ((event: { source: Scheduler, dependencyEdit: DependencyEdit, dependencyRecord: DependencyModel }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     */
    (e: 'beforeDependencyEditShow', params: ((event: { source: Scheduler, dependencyEdit: DependencyEdit, dependencyRecord: DependencyModel, editor: Popup }) => void)|string): void
    /**
     ...
     */
    (e: 'beforeDependencySave', params: ((event: { source: Scheduler, dependencyRecord: DependencyModel, values: object }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source
     * @param {ResourceModel} params.event.resourceRecord
     * @param {Date} params.event.date The datetime associated with the drag start point.
     */
    (e: 'beforeDragCreate', params: ((event: { source: Scheduler, resourceRecord: ResourceModel, date: Date }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     */
    (e: 'beforeDragCreateFinalize', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, eventElement: HTMLElement, context: { startDate: Date, endDate: Date, async: boolean, finalize: Function } }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source The Scheduler instance
     * @param {EventModel} params.event.eventRecord The record about to be added
     * @param {ResourceModel[]} params.event.resourceRecords Resources that the record is assigned to
     * @param {AssignmentModel[]} params.event.assignmentRecords The assignment records
     */
    (e: 'beforeEventAdd', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecords: ResourceModel[], assignmentRecords: AssignmentModel[] }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {boolean} params.event.context.finalize.removeRecords Provide `false` to the function to prevent the removal.
     */
    (e: 'beforeEventDelete', params: ((event: { source: Scheduler|any, eventRecords: EventModel[], context: { finalize: { removeRecords?: boolean } } }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source Scheduler instance
     * @param {EventModel} params.event.eventRecord Event record the drag starts from
     * @param {ResourceModel} params.event.resourceRecord Resource record the drag starts from
     * @param {EventModel[]} params.event.eventRecords Event records being dragged
     * @param {AssignmentModel[]} params.event.assignmentRecords Assignment records being dragged
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'beforeEventDrag', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], domEvent: MouseEvent }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {EventModel[]} params.event.context.eventRecords Event records being dragged
     * @param {AssignmentModel[]} params.event.context.assignmentRecords Assignment records being dragged
     * @param {EventModel} params.event.context.targetEventRecord Event record for drop target
     * @param {ResourceModel} params.event.context.newResource Resource record for drop target
     ...
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'beforeEventDropFinalize', params: ((event: { source: Scheduler, context: { dropData: DropData, async: boolean, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], targetEventRecord: EventModel, newResource: ResourceModel, valid: boolean, finalize: Function }, domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {EventModel} params.event.eventRecord The record about to be shown in the event editor.
     * @param {ResourceModel} params.event.resourceRecord The Resource record for the event. If the event is being created, it will not contain a resource, so this parameter specifies the resource the event is being created for.
     * @param {HTMLElement} params.event.eventElement The element which represents the event in the scheduler display.
     */
    (e: 'beforeEventEdit', params: ((event: { source: Scheduler, eventEdit: EventEdit, eventRecord: EventModel, resourceRecord: ResourceModel, eventElement: HTMLElement }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     */
    (e: 'beforeEventEditShow', params: ((event: { source: Scheduler, eventEdit: EventEdit, eventRecord: EventModel, resourceRecord: ResourceModel, eventElement: HTMLElement, editor: Popup }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source Scheduler instance
     * @param {EventModel} params.event.eventRecord Event record being resized
     * @param {ResourceModel} params.event.resourceRecord Resource record the resize starts within
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'beforeEventResize', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, event: MouseEvent }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     */
    (e: 'beforeEventResizeFinalize', params: ((event: { source: Scheduler, context: object, eventRecord: EventModel, startDate: Date, endDate: Date, originalStartDate: Date, originalEndDate: Date, async: boolean, finalize: Function, event: Event, resizeData: EventResizeData[] }) => void)|string): void
    /**
     ...
     * @param {Scheduler} params.event.source The scheduler instance
     * @param {EventModel} params.event.eventRecord The record about to be saved
     * @param {ResourceModel[]} params.event.resourceRecords The resources to which the event is assigned
     * @param {object} params.event.values The new values
     ...
     */
    (e: 'beforeEventSave', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecords: ResourceModel[], values: object, context: { async?: boolean, finalize: Function } }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {string} params.event.action One of the actions 'select', 'deselect', 'update', 'clear'
     * @param {EventModel[]} params.event.selected An array of events that will be added to the selection.
     * @param {EventModel[]} params.event.deselected An array of events that will be removed from the selection.
     * @param {EventModel[]} params.event.selection The currently selected events, before applying `selected` and `deselected`.
     */
    (e: 'beforeEventSelectionChange', params: ((event: { action: string, selected: EventModel[], deselected: EventModel[], selection: EventModel[] }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source The scheduler
     * @param {DependencyModel} params.event.dependency
     * @param {MouseEvent} params.event.event
     */
    (e: 'dependencyClick', params: ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event
     */
    (e: 'dependencyContextMenu', params: ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event
     */
    (e: 'dependencyDblClick', params: ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event
     */
    (e: 'dependencyMouseOut', params: ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event
     */
    (e: 'dependencyMouseOver', params: ((event: { source: Scheduler, dependency: DependencyModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {TimeSpan} params.event.source The source task
     * @param {TimeSpan} params.event.target The target task
     * @param {number} params.event.dependencyType The dependency type, see [Type](https://bryntum.com/products/scheduler/docs/api/Scheduler/model/DependencyBaseModel#property-Type-static)
     */
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source
     * @param {EventModel} params.event.eventRecord The new `EventModel` record.
     * @param {ResourceModel} params.event.resourceRecord The resource for the row in which the event is being created.
     ...
     */
    (e: 'dragCreateEnd', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, event: MouseEvent, eventElement: HTMLElement }) => void)|string): void
    /**
     ...
     */
    (e: 'dragCreateStart', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, eventElement: HTMLElement }) => void)|string): void
    /**
     ...
     * @param {EventModel} params.event.eventRecord The new event record.
     * @param {ResourceModel} params.event.resourceRecord The resource assigned to the new event.
     */
    (e: 'eventAutoCreated', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source This Scheduler
     * @param {EventModel} params.event.eventRecord Event record
     * @param {AssignmentModel} params.event.assignmentRecord Assignment record
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventClick', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventContextMenu', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventDblClick', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {ResourceModel} params.event.resourceRecord Resource record the drag started from
     * @param {ResourceModel} params.event.newResource Resource at the current location
     * @param {object} params.event.context
     * @param {boolean} params.event.context.valid Set this to `false` to signal that the current drop position is invalid.
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'eventDrag', params: ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], startDate: Date, endDate: Date, resourceRecord: ResourceModel, newResource: ResourceModel, context: { valid: boolean }, domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'eventDragAbort', params: ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'eventDragStart', params: ((event: { source: Scheduler, resourceRecord: ResourceModel, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'eventDrop', params: ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], externalDropTarget: HTMLElement, isCopy: boolean, context: { targetEventRecord: EventModel, newResource: ResourceModel }, domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {EventModel} params.event.record The record
     */
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source This Scheduler
     * @param {EventModel[]} params.event.eventRecords The selected event records
     * @param {AssignmentModel[]} params.event.assignmentRecords The selected assignment records
     * @param {KeyboardEvent} params.event.event Browser event
     */
    (e: 'eventKeyDown', params: ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], event: KeyboardEvent }) => void)|string): void
    /**
     ...
     * @param {KeyboardEvent} params.event.event Browser event
     */
    (e: 'eventKeyUp', params: ((event: { source: Scheduler, eventRecords: EventModel[], assignmentRecords: AssignmentModel[], event: KeyboardEvent }) => void)|string): void
    /**
     ...
     * @param {Scheduler} params.event.source
     * @param {Record<string, MenuItemConfig>} params.event.items Menu item configs
     * @param {EventModel} params.event.eventRecord Event record for which the menu was triggered
     * @param {ResourceModel} params.event.resourceRecord Resource record
     * @param {AssignmentModel} params.event.assignmentRecord Assignment record, if assignments are used
     ...
     */
    (e: 'eventMenuBeforeShow', params: ((event: { source: Scheduler, items: Record<string, MenuItemConfig>, eventRecord: EventModel, resourceRecord: ResourceModel, assignmentRecord: AssignmentModel, eventElement: HTMLElement, event?: MouseEvent }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {EventModel} params.event.eventRecord
     * @param {ResourceModel} params.event.resourceRecord
     * @param {AssignmentModel} params.event.assignmentRecord Assignment record, if assignments are used
     * @param {HTMLElement} params.event.eventElement
     */
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventMouseDown', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventMouseEnter', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventMouseLeave', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventMouseOut', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventMouseOver', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventMouseUp', params: ((event: { source: Scheduler, eventRecord: EventModel, assignmentRecord: AssignmentModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     */
    (e: 'eventPartialResize', params: ((event: { source: Scheduler, eventRecord: EventModel, startDate: Date, endDate: Date, element: HTMLElement, resizeData: EventResizeData[] }) => void)|string): void
    /**
     ...
     * @param {EventResizeData[]} params.event.resizeData Resize data for selected events
     */
    (e: 'eventResizeEnd', params: ((event: { source: Scheduler, changed: boolean, eventRecord: EventModel, resizeData: EventResizeData[] }) => void)|string): void
    /**
     ...
     * @param {ResourceModel} params.event.resourceRecord Resource record the resize starts within
     * @param {MouseEvent} params.event.event Browser event
     * @param {EventResizeData[]} params.event.resizeData Resize data for selected events. Only available when [resizeSelected](https://bryntum.com/products/scheduler/docs/api/Scheduler/feature/EventResize#config-resizeSelected) is `true`
     */
    (e: 'eventResizeStart', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, event: MouseEvent, resizeData: EventResizeData[] }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {'select'|'deselect'|'update'|'clear'} params.event.action One of the actions 'select', 'deselect', 'update', 'clear'
     * @param {EventModel[]} params.event.selected An array of the Events added to the selection.
     * @param {EventModel[]} params.event.deselected An array of the Event removed from the selection.
     * @param {EventModel[]} params.event.selection The new selection.
     */
    (e: 'eventSelectionChange', params: ((event: { action: 'select'|'deselect'|'update'|'clear', selected: EventModel[], deselected: EventModel[], selection: EventModel[] }) => void)|string): void
    /**
     ...
     * @param {EventModel[]} params.event.eventRecords The event records about to be pasted
     * @param {AssignmentModel[]} params.event.assignmentRecords The assignment records about to be pasted
     * @param {EventModel[]} params.event.originalEventRecords The event records that were copied
     * @param {AssignmentModel[]} params.event.originalAssignmentRecords The assignment records that were copied
     * @param {Date} params.event.date The paste date
     * @param {ResourceModel} params.event.resourceRecord The target resource record
     * @param {boolean} params.event.isCut `true` if this is a cut action
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source This Scheduler
     * @param {EventModel} params.event.eventRecord The event record
     * @param {ResourceModel} params.event.resourceRecord The resource record
     * @param {AssignmentModel} params.event.assignmentRecord The assignment record
     ...
     */
    (e: 'releaseEvent', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, assignmentRecord: AssignmentModel, renderData: object, element: HTMLElement }) => void)|string): void
    /**
     ...
     * @param {ResourceModel} params.event.resourceRecord The resource record
     * @param {AssignmentModel} params.event.assignmentRecord The assignment record
     * @param {object} params.event.renderData An object containing details about the event rendering, see [eventRenderer](https://bryntum.com/products/scheduler/docs/api/Scheduler/view/mixin/SchedulerEventRendering#config-eventRenderer) for details
     ...
     * @param {HTMLElement} params.event.element The event bar element
     */
    (e: 'renderEvent', params: ((event: { source: Scheduler, eventRecord: EventModel, resourceRecord: ResourceModel, assignmentRecord: AssignmentModel, renderData: object, isRepaint: boolean, isReusingElement: boolean, element: HTMLElement }) => void)|string): void
    /**
     ...
     */
    (e: 'resourceHeaderClick', params: ((event: { source: Scheduler, resourceRecord: ResourceModel, event: Event }) => void)|string): void
    /**
     ...
     * @param {Event} params.event.event The event
     */
    (e: 'resourceHeaderContextmenu', params: ((event: { source: Scheduler, resourceRecord: ResourceModel, event: Event }) => void)|string): void
    /**
     ...
     * @param {Event} params.event.event The event
     */
    (e: 'resourceHeaderDblclick', params: ((event: { source: Scheduler, resourceRecord: ResourceModel, event: Event }) => void)|string): void
    /**
     ...
     * @param {Record<string, MenuItemConfig>} params.event.items Menu item configs
     * @param {Column} params.event.column Column
     * @param {ResourceModel} params.event.resourceRecord Record
     */
    (e: 'resourceMenuBeforeShow', params: ((event: { source: Scheduler, menu: Menu, items: Record<string, MenuItemConfig>, column: Column, resourceRecord: ResourceModel }) => Promise<boolean>|boolean|void)|string): void
    /**
     * This event fires on the owning scheduler when an item is selected in the context menu.
     * @param {string} e Event name
     * @param {object} params Event parameters
     ...
     * @param {Menu} params.event.menu The menu
     * @param {MenuItem} params.event.item Selected menu item
     * @param {ResourceModel} params.event.record Record
     */
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'scheduleClick', params: ((event: { source: Scheduler, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'scheduleContextMenu', params: ((event: { source: Scheduler, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'scheduleDblClick', params: ((event: { source: Scheduler, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {HTMLElement} params.event.eventElement
     */
    (e: 'scheduleMenuBeforeShow', params: ((event: { source: Scheduler, items: Record<string, MenuItemConfig>, eventRecord: EventModel, resourceRecord: ResourceModel, date: Date, assignmentRecord: AssignmentModel, eventElement: HTMLElement }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     */
    (e: 'scheduleMenuShow', params: ((event: { source: Scheduler, items: Record<string, MenuItemConfig>, menu: Menu, resourceRecord: ResourceModel, date: Date, targetElement: HTMLElement }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'scheduleMouseDown', params: ((event: { source: Scheduler, date: Date, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'scheduleMouseEnter', params: ((event: { source: Scheduler, date: Date, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'scheduleMouseMove', params: ((event: { source: Scheduler, date: Date, tick: TimeSpan, tickIndex: number, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'scheduleMouseUp', params: ((event: { source: Scheduler, date: Date, tickStartDate: Date, tickEndDate: Date, row: Row, index: number, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string): void
    /**
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof SchedulerBase>({
        me,
        props,
        emit,
        widgetData,
