...
import type { AlignSpec, Base, ButtonListeners, ContainerItemConfig, DomConfig, MaskConfig, Menu, MenuItemConfig, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
import { Button } from '@bryntum/scheduler';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Core/widget/Button#config-ariaLive)
     */
    ariaLive ? : string
    /**
