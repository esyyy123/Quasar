import type { AlignSpec, Base, ButtonListeners, ContainerItemConfig, DomConfig, MaskConfig, MenuItemConfig, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
