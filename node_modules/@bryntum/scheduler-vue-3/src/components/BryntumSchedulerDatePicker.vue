...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Scheduler/widget/SchedulerDatePicker#config-ariaLive)
     */
    ariaLive ? : string
    /**
