import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, TabConfig, TextAreaPickerFieldListeners, TooltipConfig, Widget, WidgetConfig } from '@bryntum/scheduler';
