...
import type { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, EditorListeners, InputFieldConfig, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
import { Editor } from '@bryntum/scheduler';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Core/widget/Editor#config-ariaLive)
     */
    ariaLive ? : string
    /**
...
const emit = defineEmits<{
     ...
     * @param {boolean|object} params.event.matchSize Whether to match the target size. See [matchSize](https://bryntum.com/products/scheduler/docs/api/Core/widget/Editor#config-matchSize)
     * @param {boolean} params.event.matchSize.width Match width
     * @param {boolean} params.event.matchSize.height Match height
     * @param {boolean} params.event.matchFont Whether to match the target's font. See [matchFont](https://bryntum.com/products/scheduler/docs/api/Core/widget/Editor#config-matchFont)
