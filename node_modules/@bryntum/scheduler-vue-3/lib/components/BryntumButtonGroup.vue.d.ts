import type { AlignSpec, Base, Button, ButtonConfig, ButtonGroupListeners, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, MaskConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
import { ButtonGroup } from '@bryntum/scheduler';
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Core/widget/ButtonGroup#config-ariaLive)
     */
