import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, NumberFieldListeners, NumberFormatConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
