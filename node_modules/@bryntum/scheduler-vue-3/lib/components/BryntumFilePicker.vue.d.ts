import type { AlignSpec, Base, ButtonConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, FileFieldConfig, FilePickerListeners, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
import { FilePicker } from '@bryntum/scheduler';
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Core/widget/FilePicker#config-ariaLive)
     */
