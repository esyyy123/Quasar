import type { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, MaskConfig, MenuItemConfig, Model, ProjectModel, ProjectModelConfig, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, UndoRedoListeners, Widget } from '@bryntum/scheduler';
import { UndoRedo } from '@bryntum/scheduler';
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Scheduler/widget/UndoRedo#config-ariaLive)
     */
