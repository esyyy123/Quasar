import type { AssignmentModel, AssignmentModelConfig, AssignmentStore, AssignmentStoreConfig, DependencyModel, DependencyModelConfig, DependencyStore, DependencyStoreConfig, EventModel, EventModelConfig, EventStore, EventStoreConfig, Model, ModelConfig, ResourceModel, ResourceModelConfig, ResourceStore, ResourceStoreConfig, ResourceTimeRangeModel, ResourceTimeRangeModelConfig, ResourceTimeRangeStore, ResourceTimeRangeStoreConfig, StateTrackingManager, StateTrackingManagerConfig, Store, StoreConfig, TimeRangeModel, TimeRangeModelConfig, TimeRangeStore, TimeSpan } from '@bryntum/scheduler';
import { ProjectModel } from '@bryntum/scheduler';
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
    /**
     * A flag, indicating whether the dates and duration calculations should adjust the result to DST time shift.
     */
    adjustDurationToDST?: Boolean | undefined;
    /**
     ...
     */
    assignmentModelClass?: typeof AssignmentModel | undefined;
    /**
     ...
     * objects.
     */
    assignmentsData?: AssignmentModel[] | AssignmentModelConfig[] | undefined;
    /**
     ...
     */
    assignmentStoreClass?: object | typeof AssignmentStore | undefined;
    /**
     ...
     */
    children?: Boolean | object[] | Model[] | ModelConfig[] | undefined;
    /**
     ...
     * objects.
     */
    dependenciesData?: DependencyModel[] | DependencyModelConfig[] | undefined;
    /**
     ...
     */
    dependencyModelClass?: typeof DependencyModel | undefined;
    /**
     ...
     */
    dependencyStoreClass?: object | typeof DependencyStore | undefined;
    /**
     ...
     */
    eventModelClass?: typeof EventModel | undefined;
    /**
     ...
     */
    eventsData?: EventModel[] | EventModelConfig[] | undefined;
    /**
     ...
     */
    eventStoreClass?: object | typeof EventStore | undefined;
    /**
     ...
     */
    orderedParentIndex?: number | undefined;
    /**
     * This is a read-only field provided in server synchronization packets to specify
     ...
     * [lazyLoad](https://bryntum.com/products/scheduler/docs/api/Core/data/Store#config-lazyLoad). It is also required for lazy load functionality in a Tree store. The
     * number specified should reflect the <strong>total</strong> amount of children of a parent node, including nested descendants.
     */
    remoteChildCount?: number | undefined;
    /**
     ...
     */
    resourceModelClass?: typeof ResourceModel | undefined;
    /**
     ...
     */
    resourcesData?: ResourceModel[] | ResourceModelConfig[] | undefined;
    /**
     ...
     */
    resourceStoreClass?: object | typeof ResourceStore | undefined;
    /**
     ...
     */
    resourceTimeRangesData?: ResourceTimeRangeModel[] | undefined;
    /**
     ...
     */
    resourceTimeRangeStoreClass?: object | typeof ResourceTimeRangeStore | undefined;
    /**
     ...
     */
    silenceInitialCommit?: Boolean | undefined;
    /**
     * Configuration options to provide to the STM manager
     */
    stm?: StateTrackingManager | StateTrackingManagerConfig | undefined;
    /**
     ...
     */
    timeRanges?: TimeRangeModel[] | TimeRangeModelConfig[] | undefined;
    /**
     ...
     */
    timeRangesData?: TimeSpan[] | undefined;
    /**
     ...
     */
    timeRangeStoreClass?: object | typeof TimeRangeStore | undefined;
    /**
     ...
     */
    toJSONResultFormat?: "inlineData" | "model" | undefined;
    /**
    ...
    change: (params: string | ((event: {
        source: any;
        store: Store;
        action: "filter" | "dataset" | "remove" | "add" | "removeAll" | "replace" | "update" | "clearchanges";
        record: Model;
        records: Model[];
        changes: object;
    }) => void)) => void;
    dataReady: (params: string | ((event: {
        source: any;
    ...
    onDataReady?: ((params: string | ((event: {
        source: any;
        isInitialCommit: boolean;
        records: Set<any>;
    }) => void)) => any) | undefined;
