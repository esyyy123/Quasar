import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Model, NumberFieldListeners, NumberFormatConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/scheduler';
import { NumberField } from '@bryntum/scheduler';
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/scheduler/docs/api/Core/widget/NumberField#config-ariaLive)
     */
