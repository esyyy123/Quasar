...
import type { AlignSpec, Base, CollectionFilterConfig, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, FieldFilterPicker, FieldFilterPickerConfig, FieldFilterPickerGroup, Grid, GridFieldFilterPickerGroupListeners, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
import { GridFieldFilterPickerGroup } from '@bryntum/schedulerpro';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-adopt)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-align)
     */
     ...
     * This should be a subset of the field names found in the [grid](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-grid)'s store. When supplied,
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-ariaLabel)
     */
    ariaLabel ? : string
    /**
     * The `aria-live` value for this widget.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-ariaLive)
     */
    ariaLive ? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-bubbleEvents)
     */
    bubbleEvents ? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-callOnFunctions)
     */
     ...
     * [store](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPickerGroup#config-store).
     * @param {*} filter filter for checking
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-cls)
     */
    cls ? : string|object
    config ? : object
    /**
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-defaultFocus)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-draggable)
     */
    draggable ? : Boolean|{
    ...
    extraData ? : any
    /**
     * Array of [CollectionFilter](https://bryntum.com/products/schedulerpro/docs/api/Core/util/CollectionFilter) configuration objects. One
     * [FieldFilterPicker](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPicker) will be created
     * for each object in the array.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-filters)
     */
    ...
    floating ? : Boolean
    /**
     * Optional function that returns [FieldFilterPicker](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPicker) configuration properties for
     ...
     * [FieldFilterPicker](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPicker) representing that filter.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-getFieldFilterPickerConfig)
    ...
    /**
     * [Grid](https://bryntum.com/products/schedulerpro/docs/api/Grid/view/Grid) from which to read the available field list. In order to
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-grid)
     */
    grid ? : Grid
    /**
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-hideAnimation)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-hideWhenEmpty)
     */
    hideWhenEmpty ? : Boolean
    /**
     * The HTML to display initially or a function returning the markup (called at widget construction time).
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-html)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-ignoreParentReadOnly)
     */
     ...
     * as an array.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-items)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-keyMap)
     */
    keyMap ? : Record<string, string>
    /**
     * The short name of a helper class which manages rendering and styling of child items.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-layout)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-layoutStyle)
     */
    layoutStyle ? : object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-lazyItems)
     */
    lazyItems ? : Record<string, ContainerItemConfig>|ContainerItemConfig[]|Widget[]
    /**
     * When `limitToProperty` is set to the name of an available field (as specified either
     * explicitly in [fields](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPickerGroup#config-fields) or implicitly in the
     * [store](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPickerGroup#config-store)'s model), it has the following effects:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-limitToProperty)
     */
    limitToProperty ? : string
    /**
     * The listener set for this object.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-listeners)
     */
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-localizableProperties)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-namedItems)
     */
    namedItems ? : Record<string, ContainerItemConfig>
    /**
     * When specified, overrides the built-in list of available operators. See
     * [operators](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPicker#config-operators).
     */
    operators ? : object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-owner)
     */
    owner ? : Widget
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-positioned)
     */
    positioned ? : Boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-readOnly)
     */
    readOnly ? : Boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-record)
     */
    record ? : Model
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-ripple)
     */
    ripple ? : Boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-scrollable)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-showAnimation)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-textContent)
     */
    textContent ? : Boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-tooltip)
     */
    tooltip ? : string|TooltipConfig
    /**
     * Whether to raise [change](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPickerGroup#event-change) events as the user types into a value field. If `false`,
     * [change](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPickerGroup#event-change) events will be raised only when the value input field's own `change` event
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-ui)
     */
    ui ? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-x)
     */
    x ? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#config-y)
     */
    y ? : number
...
const emit = defineEmits<{
     ...
     * @param {FieldFilterPicker} params.event.source The FieldFilterPicker instance that fired the event.
     * @param {CollectionFilterConfig} params.event.filter The [CollectionFilter](https://bryntum.com/products/schedulerpro/docs/api/Core/util/CollectionFilter) configuration object for the filter represented by this [FieldFilterPicker](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldFilterPicker).
     */
    (e: 'beforeAddFilter', params: ((event: { source: FieldFilterPicker, filter: CollectionFilterConfig }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {FieldFilterPickerGroup} params.event.source The FieldFilterPickerGroup instance that fired the event.
     * @param {CollectionFilterConfig[]} params.event.filters The array of [CollectionFilter](https://bryntum.com/products/schedulerpro/docs/api/Core/util/CollectionFilter) configuration objects currently represented by the FieldFilterPickerGroup. <strong>IMPORTANT:</strong> Note that this includes all filters currently present in the UI, including partially completed ones that may not be ready to apply to a Store. To retrieve only valid filters, use the `validFilters` parameter on this event, or filter out incomplete filters in your own code.
     * @param {CollectionFilterConfig[]} params.event.validFilters The subset of [CollectionFilter](https://bryntum.com/products/schedulerpro/docs/api/Core/util/CollectionFilter) configuration objects in the `filters` parameter on this event that are complete and valid for application to a Store.
     */
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Grid/widget/GridFieldFilterPickerGroup#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
