import type { AlignSpec, Base, ContainerItemConfig, DisplayFieldListeners, DomConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
