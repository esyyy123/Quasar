import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, SlideToggleListeners, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
