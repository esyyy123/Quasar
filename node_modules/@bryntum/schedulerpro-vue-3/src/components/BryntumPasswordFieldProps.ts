import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, PasswordFieldListeners, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
