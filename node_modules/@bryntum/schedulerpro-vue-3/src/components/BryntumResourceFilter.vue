<!-- Vue 3 wrapper for Bryntum ResourceFilter -->
...
const emit = defineEmits<{
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {List} params.event.source The List instance
     * @param {Model} params.event.record Activated record
     * @param {number} params.event.args List item index
     * @param {Event} params.event.event Triggering event
     */
    (e: 'beforeItem', params: ((event: { source: List, record: Model, args: number, event: Event }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ResourceFilter#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * @param {Field} params.event.source This ResourceFilter
     */
     ...
     * @param {Event} params.event.event Triggering event
     */
    (e: 'item', params: ((event: { source: List, record: Model, index: number, event: Event }) => void)|string): void
    /**
     * Triggered when a widget which had been in a non-visible state for any reason
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ResourceFilter#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * @param {object} params.event Event object
     * @param {List} params.event.source The List instance
     * @param {Model[]} params.event.selected An array of the currently selected records
     */
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {Model} params.event.record The parent record which has been toggled
     * @param {boolean} params.event.collapse Collapsed (true) or expanded (false)
     */
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof ResourceFilter>({
        me,
        props,
        emit,
        widgetData,
