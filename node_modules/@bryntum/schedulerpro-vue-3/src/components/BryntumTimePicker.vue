<!-- Vue 3 wrapper for Bryntum TimePicker -->
...
const emit = defineEmits<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/TimePicker#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/TimePicker#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {Date} params.event.time The selected time.
     */
    (e: 'timeChange', params: ((event: { time: Date }) => void)|string): void
    /**
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof TimePicker>({
        me,
        props,
        emit,
        widgetData,
