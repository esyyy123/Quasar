...
import type { AbstractCrudManager, AssignmentModel, AssignmentModelConfig, AssignmentStore, AssignmentStoreConfig, Base, CalendarManagerStore, CalendarManagerStoreConfig, CalendarModel, CalendarModelConfig, CoreStateTrackingManager, CrudManagerStoreDescriptor, DependencyModel, DependencyModelConfig, DependencyStore, DependencyStoreConfig, DurationUnit, EventModel, EventModelConfig, EventStore, EventStoreConfig, Model, ModelConfig, ProjectModelListeners, ResourceAllocationInfo, ResourceModel, ResourceModelConfig, ResourceStore, ResourceStoreConfig, ResourceTimeRangeModel, ResourceTimeRangeModelConfig, ResourceTimeRangeStore, ResourceTimeRangeStoreConfig, SchedulerProjectModel, StateTrackingManagerConfig, Store, StoreConfig, TimeRangeStore, TimeSpan, TimeSpanConfig } from '@bryntum/schedulerpro';
...
const props = defineProps<{
     ...
     * [lazyLoad](https://bryntum.com/products/schedulerpro/docs/api/Core/data/Store#config-lazyLoad). It is also required for lazy load functionality in a Tree store. The
    ...
    /**
     * When `true` the project's manually scheduled tasks adjust their duration by excluding the non-working time from
     * it, according to the calendar. However, this may lead to inconsistencies, when moving an event which both starts
...
const emit = defineEmits<{
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {AbstractCrudManager} params.event.source The CRUD manager.
     * @param {object} params.event.pack The data package which contains data for all stores managed by the crud manager.
     */
    (e: 'beforeLoad', params: ((event: { source: AbstractCrudManager, pack: object }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     */
    (e: 'beforeLoadApply', params: ((event: { source: AbstractCrudManager, response: object, options: object }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event.response The decoded server response object.
     */
    (e: 'beforeResponseApply', params: ((event: { source: AbstractCrudManager, requestType: 'sync'|'load', response: object }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {AbstractCrudManager} params.event.crudManager The CRUD manager.
     ...
     */
    (e: 'beforeSend', params: ((event: { crudManager: AbstractCrudManager, params: object, requestType: 'sync'|'load', requestConfig: object }) => Promise<void>)|string): void
    /**
     ...
     * @param {object} params.event.pack The data package which contains data for all stores managed by the crud manager.
     */
    (e: 'beforeSync', params: ((event: { source: AbstractCrudManager, pack: object }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event.response The decoded server response object.
     */
    (e: 'beforeSyncApply', params: ((event: { source: AbstractCrudManager, response: object }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {SchedulerProjectModel|any} params.event.source This project
     * @param {Store} params.event.store Affected store
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {ProjectModel} params.event.source The project
     ...
     * @param {AbstractCrudManager} params.event.source The CRUD manager.
     * @param {object} params.event.response The decoded server response object.
     * @param {object} params.event.responseOptions The server response options.
     */
    (e: 'load', params: ((event: { source: AbstractCrudManager, response: object, responseOptions: object }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {AbstractCrudManager} params.event.source The CRUD manager instance.
     * @param {object} params.event.response The decoded server response object.
     * @param {string} params.event.responseText The raw server response text
     * @param {object} params.event.responseOptions The response options.
     */
    (e: 'loadFail', params: ((event: { source: AbstractCrudManager, response: object, responseText: string, responseOptions: object }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {ProjectModel} params.event.source The owning project
     ...
     * @param {object} params.event.responseOptions The server response options.
     */
    (e: 'requestDone', params: ((event: { source: AbstractCrudManager, requestType: 'sync'|'load', response: object, responseOptions: object }) => void)|string): void
    /**
     ...
     * @param {object} params.event.responseOptions The response options.
     */
    (e: 'requestFail', params: ((event: { source: AbstractCrudManager, requestType: 'sync'|'load', response: object, responseText: string, responseOptions: object }) => void)|string): void
    /**
     ...
     * @param {object} params.event.responseOptions The server response options.
     */
    (e: 'sync', params: ((event: { source: AbstractCrudManager, response: object, responseOptions: object }) => void)|string): void
    /**
     ...
     * @param {object} params.event.responseOptions The response options.
     */
    (e: 'syncFail', params: ((event: { source: AbstractCrudManager, response: object, responseText: string, responseOptions: object }) => void)|string): void
}>();
