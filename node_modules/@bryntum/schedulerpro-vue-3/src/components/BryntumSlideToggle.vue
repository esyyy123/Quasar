<!-- Vue 3 wrapper for Bryntum SlideToggle -->
...
import type { AlignSpec, Base, Checkbox, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, SlideToggleListeners, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
import { SlideToggle } from '@bryntum/schedulerpro';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-adopt)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-align)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-ariaLabel)
     */
    ariaLabel ? : string
    /**
     * The `aria-live` value for this widget.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-ariaLive)
     */
    ariaLive ? : string
    /**
     * Specify `true` to automatically [collapse](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/FieldContainer#config-collapsed) the field's
     * [container](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Checkbox#config-container) when the field is not [checked](#Core/widget/Checkbox#property-checked).
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-autoCollapse)
     * @returns {boolean}
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-bubbleEvents)
     */
    bubbleEvents ? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-callOnFunctions)
     */
    ...
    checked ? : Boolean
    /**
     * The value to provide for this widget in [values](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Container#property-values) when it is
     * [checked](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Checkbox#property-checked).
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-cls)
     */
    cls ? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-container)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-containValues)
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-draggable)
     */
    draggable ? : Boolean|{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-editable)
     */
    editable ? : Boolean
    extraData ? : any
    /**
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-hideAnimation)
     */
     ...
     * a field's units.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-hint)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-hintHtml)
     * @param {object} data A data object
     * @param {Field} data.source A reference to the field instance
     * @param {*} data.value The current value of the field
     * @returns {string}
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-ignoreParentReadOnly)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-inline)
     */
    inline ? : Boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-keyMap)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-keyStrokeChangeDelay)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-labels)
     */
    labels ? : object[]
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-listeners)
     */
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-localizableProperties)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-name)
     */
    name ? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-owner)
     */
    owner ? : Widget
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-positioned)
     */
    positioned ? : Boolean
    /**
     ...
     * are unresponsive.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-readOnly)
     */
    readOnly ? : Boolean
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-ripple)
     */
    ripple ? : Boolean|{
        delegate?: string
        color?: string
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-showAnimation)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-tabIndex)
     */
    tabIndex ? : number
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-tooltip)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-triggers)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-ui)
     */
    ui ? : string|object
    /**
     * The value to provide for this widget in [values](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Container#property-values) when it is not
     * [checked](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Checkbox#property-checked).
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-uncheckedValue)
     */
    uncheckedValue ? : any
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-x)
     */
    x ? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#config-y)
     */
    y ? : number
...
const emit = defineEmits<{
     ...
     * @param {Checkbox} params.event.source Checkbox
     * @param {boolean} params.event.checked Checked state (=value)
     * @param {boolean} params.event.value This field's value
     * @param {boolean} params.event.valid True if this field is in a valid state
     * @param {boolean} params.event.oldValue This field's previous value
     ...
     */
    (e: 'action', params: ((event: { source: Checkbox, checked: boolean, value: boolean, valid: boolean, oldValue: boolean, userAction: boolean, event: Event }) => void)|string): void
    /**
     ...
     */
    (e: 'beforeChange', params: ((event: { source: Checkbox, checked: boolean }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * @param {Event} params.event.event The triggering DOM event if any
     */
    (e: 'change', params: ((event: { source: Checkbox, checked: boolean, value: boolean, oldValue: boolean, userAction: boolean, valid: boolean, event: Event }) => void)|string): void
    /**
     * Fired when this field is [cleared](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Field#function-clear).
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#event-clear)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {Checkbox} params.event.source The checkbox
     * @param {Event} params.event.event DOM event
     */
    (e: 'click', params: ((event: { source: Checkbox, event: Event }) => void)|string): void
    /**
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/SlideToggle#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof SlideToggle>({
        me,
        props,
        emit,
        widgetData,
