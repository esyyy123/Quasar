import type { AlignSpec, Base, Collection, CollectionConfig, DomConfig, GroupBarListeners, MaskConfig, Model, Rectangle, Scroller, ScrollerConfig, Store, StoreConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
