<!-- Vue 3 wrapper for Bryntum PagingToolbar -->
...
const emit = defineEmits<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/PagingToolbar#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/PagingToolbar#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof PagingToolbar>({
        me,
        props,
        emit,
        widgetData,
