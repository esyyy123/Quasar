import type { AlignSpec, Base, ContainerItemConfig, DurationConfig, DurationUnit, EffortFieldListeners, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
