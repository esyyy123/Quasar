import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, TabConfig, TextAreaFieldListeners, TooltipConfig, Widget } from '@bryntum/schedulerpro';
