<!-- Vue 3 wrapper for Bryntum Editor -->
...
import type { AlignSpec, Base, Container, ContainerItemConfig, ContainerLayoutConfig, DomConfig, EditorListeners, InputFieldConfig, MaskConfig, MenuItemConfig, Model, Rectangle, Scroller, ScrollerConfig, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
import { Editor } from '@bryntum/schedulerpro';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-adopt)
     */
    adopt ? : HTMLElement|string
    /**
     * The alignment config for how this editor aligns to a target when asked to [startEdit](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#function-startEdit)
     */
    align ? : AlignSpec
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-ariaLabel)
     */
    ariaLabel ? : string
    /**
     * The `aria-live` value for this widget.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-ariaLive)
     */
    ariaLive ? : string
    /**
     ...
     * leaving the application to listen for the [focusOut](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#event-focusOut) event.
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-bubbleEvents)
     */
    bubbleEvents ? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-callOnFunctions)
     */
    callOnFunctions ? : Boolean
    /**
     * The name of the `key` which cancels the edit.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-cancelKey)
     */
    cancelKey ? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-cls)
     */
    cls ? : string|object
    /**
     * The name of the `key` which completes the edit.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-completeKey)
     */
    completeKey ? : string
    /**
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-defaultFocus)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-draggable)
     */
    draggable ? : Boolean|{
    ...
    extraData ? : any
    /**
     * Controls whether the editor should expand its width if the input field has overflow [startEdit](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#function-startEdit)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-hideAnimation)
     */
    hideAnimation ? : Boolean|object
    /**
     * Controls whether to hide the target element when asked to [startEdit](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#function-startEdit)
     */
    hideTarget ? : Boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-hideWhenEmpty)
     */
    hideWhenEmpty ? : Boolean
    /**
     * The HTML to display initially or a function returning the markup (called at widget construction time).
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-html)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-ignoreParentReadOnly)
     */
    ignoreParentReadOnly ? : Boolean
    /**
     * A config object, or the `type` string of the widget (usually a [Field](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Field) subclass,
     * i.e. [TextField](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/TextField)) which this editor will encapsulate.
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-invalidAction)
     */
     ...
     * as an array.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-items)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-keyMap)
     */
    keyMap ? : Record<string, string>
    /**
     * The short name of a helper class which manages rendering and styling of child items.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-layout)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-layoutStyle)
     */
    layoutStyle ? : object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-lazyItems)
     */
    lazyItems ? : Record<string, ContainerItemConfig>|ContainerItemConfig[]|Widget[]
    /**
     * The listener set for this object.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-listeners)
     */
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-localizableProperties)
     */
    ...
    /**
     * Controls whether the editor should match target element's font when asked to [startEdit](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#function-startEdit)
     */
    matchFont ? : Boolean
    /**
     * By default, an Editor matches both dimensions, width and height of the element it is targeted at in the
     * [startEdit](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#function-startEdit) function.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-matchSize)
     */
    matchSize ? : Boolean|{
        width?: Boolean
        height?: Boolean
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-namedItems)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-owner)
     */
    owner ? : Widget
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-positioned)
     */
    positioned ? : Boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-readOnly)
     */
    readOnly ? : Boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-record)
     */
    record ? : Model
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-ripple)
     */
    ripple ? : Boolean|{
        delegate?: string
        color?: string
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-scrollable)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-showAnimation)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-textContent)
     */
    textContent ? : Boolean
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-tooltip)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-ui)
     */
    ui ? : string|object
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-x)
     */
    x ? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-y)
     */
    y ? : number
...
const emit = defineEmits<{
     ...
     * @param {object} params.event.oldValue The original value.
     * @param {object} params.event.value The new value.
     * @param {Event} params.event.event Included if the cancellation was triggered by a DOM event
     * @param {Editor} params.event.source The Editor that triggered the event.
     */
    (e: 'beforeCancel', params: ((event: { oldValue: object, value: object, event: Event, source: Editor }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event.value The new value.
     * @param {Editor} params.event.source The Editor that triggered the event.
     * @param {Function} params.event.finalize An async function may be injected into this property which performs asynchronous finalization tasks such as complex validation of confirmation. The value `true` or `false` must be returned.
     * @param {object} params.event.finalize.context An object describing the editing context upon requested completion of the edit.
     */
    (e: 'beforeComplete', params: ((event: { oldValue: object, value: object, source: Editor, finalize: { context?: object } }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {HTMLElement} params.event.target The element which the Editor is to overlay to edit its content.
     * @param {Model} params.event.record The record being edited.
     * @param {string} params.event.field The name of the field if a record is being edited.
     * @param {object} params.event.value The value to be edited.
     * @param {string|AlignSpec} params.event.align How to align the editor.
     * @param {boolean} params.event.hideTarget `true` if the target is to be hidden during the edit.
     * @param {boolean|object} params.event.matchSize Whether to match the target size. See [matchSize](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-matchSize)
     * @param {boolean} params.event.matchSize.width Match width
     * @param {boolean} params.event.matchSize.height Match height
     * @param {boolean} params.event.matchFont Whether to match the target's font. See [matchFont](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#config-matchFont)
     * @param {boolean} params.event.focus Whether to focus the editor's field.
     */
    (e: 'beforeStart', params: ((event: { target: HTMLElement, record?: Model, field?: string, value: object, align: string|AlignSpec, hideTarget: boolean, matchSize: { width: boolean, height: boolean }, matchFont: boolean, focus: boolean }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {object} params.event.oldValue The original value.
     * @param {object} params.event.value The value of the field.
     * @param {Event} params.event.event Included if the cancellation was triggered by a DOM event
     * @param {Editor} params.event.source The Editor that triggered the event.
     */
    (e: 'cancel', params: ((event: { oldValue: object, value: object, event: Event, source: Editor }) => void)|string): void
    /**
     * Fires when any other event is fired from the object.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * @param {Editor} params.event.source The Editor that triggered the event.
     */
    (e: 'complete', params: ((event: { oldValue: object, value: object, source: Editor }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {Event} params.event.event The key event.
     */
    (e: 'keyDown', params: ((event: { event: Event }) => void)|string): void
    /**
     * Triggered when a widget which had been in a non-visible state for any reason
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Editor#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {object} params.event.value The starting value of the field.
     * @param {Editor} params.event.source The Editor that triggered the event.
     */
    (e: 'start', params: ((event: { value: object, source: Editor }) => void)|string): void
}>();
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof Editor>({
        me,
        props,
        emit,
        widgetData,
