...
import type { AlignSpec, Base, ContainerItemConfig, Duration, DurationConfig, DurationField, DurationUnit, EffortFieldListeners, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
