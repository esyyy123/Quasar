<!-- Vue 3 wrapper for Bryntum List -->
...
const emit = defineEmits<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/List#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/List#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof List>({
        me,
        props,
        emit,
        widgetData,
