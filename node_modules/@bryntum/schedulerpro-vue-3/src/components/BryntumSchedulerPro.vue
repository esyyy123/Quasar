<!-- Vue 3 wrapper for Bryntum SchedulerPro -->
...
import type { AjaxStore, AjaxStoreConfig, AssignmentModel, AssignmentModelConfig, AssignmentStore, AssignmentStoreConfig, Base, CalendarHighlight, CalendarHighlightConfig, CalendarModel, CalendarModelConfig, CellCopyPaste, CellCopyPasteConfig, CellEdit, CellEditConfig, CellMenu, CellMenuConfig, CellTooltip, CellTooltipConfig, Column, ColumnAutoWidth, ColumnAutoWidthConfig, ColumnDragToolbar, ColumnDragToolbarConfig, ColumnLines, ColumnLinesConfig, ColumnPicker, ColumnPickerConfig, ColumnRename, ColumnRenameConfig, ColumnReorder, ColumnReorderConfig, ColumnResize, ColumnResizeConfig, ColumnStore, ColumnStoreConfig, Container, ContainerItemConfig, CrudManager, CrudManagerConfig, CycleResolutionPopup, DateConstraint, Dependencies, DependenciesConfig, DependencyBaseModel, DependencyEdit, DependencyEditConfig, DependencyModel, DependencyModelConfig, DependencyStore, DependencyStoreConfig, DomClassList, DomConfig, DropData, DurationConfig, DurationUnit, Editor, EventBuffer, EventBufferConfig, EventColor, EventCopyPaste, EventCopyPasteConfig, EventDrag, EventDragConfig, EventDragCreate, EventDragCreateConfig, EventDragSelect, EventDragSelectConfig, EventEdit, EventEditConfig, EventFilter, EventFilterConfig, EventMenu, EventMenuConfig, EventModel, EventModelConfig, EventNonWorkingTime, EventNonWorkingTimeConfig, EventResize, EventResizeConfig, EventResizeData, EventSegmentDrag, EventSegmentDragConfig, EventSegmentResize, EventSegmentResizeConfig, EventSegments, EventSegmentsConfig, EventStore, EventStoreConfig, EventTooltip, EventTooltipConfig, ExcelExporter, ExcelExporterConfig, ExportConfig, Field, FileDrop, FileDropConfig, FillHandle, FillHandleConfig, Filter, FilterBar, FilterBarConfig, FilterConfig, Grid, GridBase, GridColumnConfig, GridLocation, GridLocationConfig, GridSelectionMode, Group, GroupConfig, GroupSummary, GroupSummaryConfig, HeaderMenu, HeaderMenuConfig, HeaderZoom, HeaderZoomConfig, Labels, LabelsConfig, LockRows, LockRowsConfig, Mask, MaskConfig, Menu, MenuItem, MenuItemConfig, MergeCells, MergeCellsConfig, Model, ModelConfig, NestedEvents, NestedEventsConfig, NonWorkingTime, NonWorkingTimeConfig, PagingToolbarConfig, Pan, PanConfig, Panel, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, PdfExport, PdfExportConfig, PercentBar, PercentBarConfig, Popup, PreserveScrollOptions, Print, PrintConfig, ProjectModel, ProjectModelConfig, QuickFind, QuickFindConfig, RecordPositionContext, RegionResize, RegionResizeConfig, ResourceHeaderConfig, ResourceMarginConfig, ResourceMenu, ResourceMenuConfig, ResourceModel, ResourceModelConfig, ResourceNonWorkingTime, ResourceNonWorkingTimeConfig, ResourceStore, ResourceStoreConfig, ResourceTimeRangeModel, ResourceTimeRangeModelConfig, ResourceTimeRangeStore, ResourceTimeRangeStoreConfig, ResourceTimeRanges, ResourceTimeRangesConfig, Row, RowCopyPaste, RowCopyPasteConfig, RowExpander, RowExpanderConfig, RowReorder, RowReorderConfig, RowResize, RowResizeConfig, ScheduleContext, ScheduleContextConfig, ScheduleMenu, ScheduleMenuConfig, ScheduleTooltip, ScheduleTooltipConfig, Scheduler, SchedulerAssignmentModel, SchedulerDependencyEdit, SchedulerDependencyModel, SchedulerEventModel, SchedulerProListeners, SchedulerResourceModel, SchedulingIssueResolutionPopup, ScrollButtons, ScrollButtonsConfig, ScrollManager, ScrollManagerConfig, Scroller, ScrollerConfig, Search, SearchConfig, SimpleEventEdit, SimpleEventEditConfig, Sort, SortConfig, Split, SplitConfig, StateProvider, StickyCells, StickyCellsConfig, StickyEvents, StickyEventsConfig, Store, StoreConfig, Stripe, StripeConfig, SubGrid, SubGridConfig, Summary, SummaryConfig, TabConfig, TaskEdit, TaskEditConfig, TaskEditorBase, TimeAxis, TimeAxisColumn, TimeAxisConfig, TimeAxisHeaderMenu, TimeAxisHeaderMenuConfig, TimeRanges, TimeRangesConfig, TimeSelection, TimeSelectionConfig, TimeSpan, TimeSpanConfig, TimeSpanHighlight, TimeSpanHighlightConfig, TimelineBase, TimelineContext, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Tree, TreeConfig, TreeGroup, TreeGroupConfig, Versions, VersionsConfig, VerticalTimeAxisColumn, VerticalTimeAxisColumnConfig, ViewPreset, ViewPresetConfig, VisibleDate, Widget } from '@bryntum/schedulerpro';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/SchedulerPro/view/SchedulerPro#config-ariaLive)
     */
    ariaLive ? : string
    /**
...
const emit = defineEmits<{
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source
     * @param {SchedulerEventModel[]} params.event.eventRecords Dropped segments
     * @param {boolean} params.event.valid
     * @param {object} params.event.context
     */
    (e: 'afterEventSegmentDrop', params: ((event: { source: Scheduler, eventRecords: SchedulerEventModel[], valid: boolean, context: object }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {SchedulerPro} params.event.source The Scheduler Pro instance
     * @param {EventModel} params.event.taskRecord Task record used in the task editor
     * @param {TaskEditorBase} params.event.editor The editor widget
     */
    (e: 'afterTaskEdit', params: ((event: { source: SchedulerPro, taskRecord: EventModel, editor: TaskEditorBase }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {SchedulerPro} params.event.source The Scheduler Pro instance
     * @param {EventModel} params.event.taskRecord The task about to be saved
     * @param {TaskEditorBase} params.event.editor The editor widget
     */
    (e: 'afterTaskSave', params: ((event: { source: SchedulerPro, taskRecord: EventModel, editor: TaskEditorBase }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source Scheduler instance
     * @param {SchedulerEventModel[]} params.event.eventRecords Segments to drag
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'beforeEventSegmentDrag', params: ((event: { source: Scheduler, eventRecords: SchedulerEventModel[], event: MouseEvent }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {Scheduler} params.event.source Scheduler instance
     * @param {object} params.event.context
     * @param {boolean} params.event.context.async Set true to not finalize the drag-drop operation immediately (e.g. to wait for user confirmation)
     * @param {SchedulerEventModel[]} params.event.context.eventRecords Dragged segments
     * @param {boolean} params.event.context.valid Set this to `false` to abort the drop immediately.
     * @param {Function} params.event.context.finalize Call this method after an <strong>async</strong> finalization flow, to finalize the drag-drop operation. This method accepts one argument: pass `true` to update records, or `false` to ignore changes
     */
    (e: 'beforeEventSegmentDropFinalize', params: ((event: { source: Scheduler, context: { async: boolean, eventRecords: SchedulerEventModel[], valid: boolean, finalize: Function } }) => void)|string): void
    /**
     * Fired on the owning Scheduler Pro before resizing starts. Return `false` to prevent the action.
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {SchedulerPro} params.event.source Scheduler Pro instance
     * @param {EventModel} params.event.eventRecord Segment being resized
     * @param {ResourceModel} params.event.resourceRecord Resource record the resize starts within
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'beforeEventSegmentResize', params: ((event: { source: SchedulerPro, eventRecord: EventModel, resourceRecord: ResourceModel, event: MouseEvent }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {SchedulerPro} params.event.source Scheduler Pro instance
     * @param {object} params.event.context
     * @param {boolean} params.event.context.async Set true to handle resize asynchronously (e.g. to wait for user confirmation)
     * @param {Function} params.event.context.finalize Call this method to finalize resize. This method accepts one argument: pass `true` to update records, or `false`, to ignore changes
     */
    (e: 'beforeEventSegmentResizeFinalize', params: ((event: { source: SchedulerPro, context: { async: boolean, finalize: Function } }) => void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {SchedulerPro} params.event.source The Scheduler Pro instance.
     * @param {EventModel} params.event.taskRecord The record about to be deleted
     * @param {TaskEditorBase} params.event.editor The editor widget
     */
    (e: 'beforeTaskDelete', params: ((event: { source: SchedulerPro, taskRecord: EventModel, editor: TaskEditorBase }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {SchedulerPro} params.event.source The Scheduler Pro instance
     * @param {TaskEdit} params.event.taskEdit The taskEdit feature
     * @param {EventModel} params.event.taskRecord The task about to be shown in the editor.
     * @param {HTMLElement} params.event.taskElement The element which represents the task
     */
    (e: 'beforeTaskEdit', params: ((event: { source: SchedulerPro, taskEdit: TaskEdit, taskRecord: EventModel, taskElement: HTMLElement }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {SchedulerPro} params.event.source The SchedulerPro instance
     * @param {TaskEdit} params.event.taskEdit The taskEdit feature
     * @param {EventModel} params.event.taskRecord The task about to be shown in the editor.
     * @param {HTMLElement} params.event.eventElement The element which represents the task
     * @param {TaskEditorBase} params.event.editor The editor
     */
     ...
     * @param {TaskEditorBase} params.event.editor The editor widget
     */
    (e: 'beforeTaskSave', params: ((event: { source: SchedulerPro, taskRecord: EventModel, editor: TaskEditorBase }) => Promise<boolean>|boolean|void)|string): void
    /**
     ...
     * @param {object} params.event Event object
     * @param {Scheduler} params.event.source Scheduler instance
     * @param {SchedulerEventModel[]} params.event.eventRecords Dragged segments
     * @param {Date} params.event.startDate Start date for the current location
     * @param {Date} params.event.endDate End date for the current location
     * @param {object} params.event.context
     * @param {boolean} params.event.context.valid Set this to `false` to signal that the current drop position is invalid.
     */
    (e: 'eventSegmentDrag', params: ((event: { source: Scheduler, eventRecords: SchedulerEventModel[], startDate: Date, endDate: Date, context: { valid: boolean } }) => void)|string): void
    /**
     ...
     * @param {SchedulerEventModel[]} params.event.eventRecords Dragged segments
     */
    (e: 'eventSegmentDragAbort', params: ((event: { source: Scheduler, eventRecords: SchedulerEventModel[] }) => void)|string): void
    /**
     ...
     * @param {Scheduler} params.event.source Scheduler instance
     */
    (e: 'eventSegmentDragReset', params: ((event: { source: Scheduler }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventSegmentDragStart', params: ((event: { source: Scheduler, eventRecords: SchedulerEventModel[], event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {SchedulerEventModel[]} params.event.eventRecords Dropped segments
     */
    (e: 'eventSegmentDrop', params: ((event: { source: Scheduler, eventRecords: SchedulerEventModel[] }) => void)|string): void
    /**
     ...
     * @param {HTMLElement} params.event.element
     */
    (e: 'eventSegmentPartialResize', params: ((event: { source: SchedulerPro, eventRecord: EventModel, startDate: Date, endDate: Date, element: HTMLElement }) => void)|string): void
    /**
     ...
     * @param {EventModel} params.event.eventRecord Segment being resized
     */
    (e: 'eventSegmentResizeEnd', params: ((event: { source: SchedulerPro, changed: boolean, eventRecord: EventModel }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.event Browser event
     */
    (e: 'eventSegmentResizeStart', params: ((event: { source: SchedulerPro, eventRecord: EventModel, resourceRecord: ResourceModel, event: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {TimelineBase} params.event.source SchedulerPro or Gantt instance
     * @param {Model} params.event.taskRecord The task record
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'percentBarDrag', params: ((event: { source: TimelineBase, taskRecord: Model, domEvent: MouseEvent }) => void)|string): void
    /**
     * Fired on the owning Scheduler or Gantt widget if a percent bar drag-drop operation is aborted
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {TimelineBase} params.event.source SchedulerPro instance
     * @param {Model} params.event.taskRecord The task record
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'percentBarDragAbort', params: ((event: { source: TimelineBase, taskRecord: Model, domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'percentBarDragStart', params: ((event: { source: TimelineBase, taskRecord: Model, domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {MouseEvent} params.event.domEvent Browser event
     */
    (e: 'percentBarDrop', params: ((event: { source: TimelineBase, taskRecord: Model, domEvent: MouseEvent }) => void)|string): void
    /**
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {SchedulerPro} params.event.source This Scheduler
     * @param {ResourceNonWorkingTime} params.event.feature The ResourceNonWorkingTime feature
     ...
     * @param {object} params.event Event object
     * @param {SchedulerPro} params.event.source The Scheduler Pro instance
     * @param {EventModel} params.event.taskRecord the task about the shown in the editor
     * @param {TaskEditorBase} params.event.editor The editor
     */
    (e: 'taskEditCanceled', params: ((event: { source: SchedulerPro, taskRecord: EventModel, editor: TaskEditorBase }) => void)|string): void
    /**
...
const widgetData = {
    instanceClass : SchedulerPro,
    instanceName  : 'SchedulerPro',
...
onMounted(() => {
    ...
    instance.value = WrapperHelper.createWidget<typeof SchedulerPro>({
        me,
        props,
        emit,
        widgetData,
