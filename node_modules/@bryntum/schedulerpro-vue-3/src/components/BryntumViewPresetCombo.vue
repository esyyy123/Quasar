<!-- Vue 3 wrapper for Bryntum ViewPresetCombo -->
...
import type { AlignSpec, Base, Combo, Field, MaskConfig, Model, Rectangle, TabConfig, TimelineBase, ViewPresetComboListeners, Widget } from '@bryntum/schedulerpro';
import { ViewPresetCombo } from '@bryntum/schedulerpro';
...
const props = defineProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-align)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-ariaDescription)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-ariaLabel)
     */
    ariaLabel ? : string
    /**
     * The `aria-live` value for this widget.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-ariaLive)
     */
    ariaLive ? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-bubbleEvents)
     */
    bubbleEvents ? : object
    /**
     * Set to `false` to not call onXXX method names (e.g. `onShow`, `onClick`), as an easy way to listen for events.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-callOnFunctions)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-cls)
     */
    cls ? : string|object
    config ? : object
    /**
     ...
     * with truthy values are used as the class names:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-contentElementCls)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-disabled)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-dock)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-draggable)
     */
    draggable ? : Boolean|{
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-hideAnimation)
     */
     ...
     * a field's units.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-hint)
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-hintHtml)
     * @param {object} data A data object
     * @param {Field} data.source A reference to the field instance
     * @param {*} data.value The current value of the field
     * @returns {string}
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-ignoreParentReadOnly)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-keyMap)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-labels)
     */
    labels ? : object[]
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-listeners)
     */
    listeners ? : ViewPresetComboListeners
    /**
     * Template string used to render the list items in the dropdown list
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-listItemTpl)
     ...
     * For example:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-localeClass)
     */
     ...
     * Example:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-localizableProperties)
     */
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-maximizeOnMobile)
     */
     ...
     * layout.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-monitorResize)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-name)
     */
    name ? : string
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-owner)
     */
    owner ? : Widget
    /**
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-positioned)
     */
    positioned ? : Boolean
    /**
     * An array containing string [ViewPreset](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/preset/ViewPreset) ids available for selection. The specified
     * presets must be [available](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/view/mixin/TimelineViewPresets#config-presets) for the
     * [client](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-client) (Scheduler, SchedulerPro or Gantt) for it to work properly. The selectable presets
     ...
     * are unresponsive.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-readOnly)
     */
    readOnly ? : Boolean
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-ripple)
     */
    ripple ? : Boolean|{
        delegate?: string
        color?: string
     ...
     * *Only valid if this Widget is [floating](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Widget#config-floating).*
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-showAnimation)
     */
     ...
     * this widget:
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-tab)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-tabIndex)
     */
    tabIndex ? : number
    /**
     * Text alignment: 'left', 'center' or 'right'. Also accepts direction neutral 'start' and 'end'.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-textAlign)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-ui)
     */
    ui ? : string|object
    /**
     * As default, a preset change by the ViewPresetCombo will result in that the `startDate` will be calculated to
     * the beginning of the [mainUnit](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/preset/ViewPreset#field-mainUnit) of the
     * [viewportCenterDate](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/view/mixin/TimelineDateMapper#property-viewportCenterDate). If the ViewPreset has a
     * [start](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/preset/ViewPreset#field-start) configured, this will be added to the calculation. The
     * `endDate` will then be calculated by adding the ViewPreset's
     * [defaultSpan](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/preset/ViewPreset#field-defaultSpan) to the `startDate`.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-useFixedDuration)
     */
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-x)
     */
    x ? : number
    /**
     * The y position for the widget.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#config-y)
     */
    y ? : number
...
const emit = defineEmits<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#event-clear)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {Field|any} params.event.source This Field
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Scheduler/widget/ViewPresetCombo#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
