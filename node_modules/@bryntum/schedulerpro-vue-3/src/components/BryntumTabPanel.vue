<!-- Vue 3 wrapper for Bryntum TabPanel -->
...
const emit = defineEmits<{
     ...
     * @param {Widget} params.event.activeItem The new active child widget.
     * @param {number} params.event.prevActiveIndex The previous active index.
     * @param {Widget} params.event.prevActiveItem The previous active child widget.
     */
    (e: 'beforeTabChange', params: ((event: { activeIndex: number, activeItem: Widget, prevActiveIndex: number, prevActiveItem: Widget }) => Promise<boolean>|boolean|void)|string): void
    /**
     * Fires when any other event is fired from the object.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/TabPanel#event-catchAll)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     ...
     * achieves visibility.
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/TabPanel#event-paint)
     * @param {string} e Event name
     * @param {object} params Event parameters
     * @param {object} params.event Event object
