import type { AlignSpec, Base, ColorDescriptor, ContainerItemConfig, EventColorFieldListeners, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
