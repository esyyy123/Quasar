...
const emit = defineEmits<{
     ...
     * @param {object} params Event parameters
     * @param {object} params.event Event object
     * @param {VersionModel} params.event.version The [VersionModel](https://bryntum.com/products/schedulerpro/docs/api/SchedulerPro/model/VersionModel) being restored
     */
