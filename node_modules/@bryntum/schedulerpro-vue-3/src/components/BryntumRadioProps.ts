import type { AlignSpec, Base, ContainerItemConfig, Field, FieldContainer, FieldContainerConfig, FieldTriggerConfig, MaskConfig, RadioListeners, Rectangle, TabConfig, TooltipConfig, Widget } from '@bryntum/schedulerpro';
