...
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     */
    appendToTargetParent?: Boolean | undefined;
    /**
     ...
     */
    blurAction?: "complete" | "cancel" | null | undefined;
    /**
     ...
     */
    fitTargetContent?: Boolean | undefined;
    /**
     * When this widget is a child of a [Container](https://bryntum.com/products/schedulerpro/docs/api/Core/widget/Container), it will by default be participating in a
     * flexbox layout. This config allows you to set this widget's
     ...
     */
    inputField?: string | Widget | InputFieldConfig | undefined;
    /**
     ...
     */
    invalidAction?: "block" | "allow" | "revert" | undefined;
    /**
     ...
     */
    listeners?: EditorListeners | undefined;
    /**
    ...
    beforeCancel: (params: string | ((event: {
        oldValue: object;
        value: object;
        event: Event;
        source: Editor;
    }) => boolean | void | Promise<boolean>)) => void;
    beforeComplete: (params: string | ((event: {
        oldValue: object;
        value: object;
        source: Editor;
        finalize: {
    ...
    beforeStart: (params: string | ((event: {
        target: HTMLElement;
        record?: Model | undefined;
    ...
    onBeforeCancel?: ((params: string | ((event: {
        oldValue: object;
        value: object;
        event: Event;
        source: Editor;
    }) => boolean | void | Promise<boolean>)) => any) | undefined;
    onBeforeComplete?: ((params: string | ((event: {
        oldValue: object;
        value: object;
        source: Editor;
        finalize: {
    ...
    onBeforeStart?: ((params: string | ((event: {
        target: HTMLElement;
        record?: Model | undefined;
        field?: string | undefined;
        value: object;
    ...
    onCancel?: ((params: string | ((event: {
        oldValue: object;
        value: object;
        event: Event;
        source: Editor;
    }) => void)) => any) | undefined;
    onComplete?: ((params: string | ((event: {
        oldValue: object;
        value: object;
        source: Editor;
    }) => void)) => any) | undefined;
    onKeyDown?: ((params: string | ((event: {
        event: Event;
    }) => void)) => any) | undefined;
    onStart?: ((params: string | ((event: {
        value: object;
        source: Editor;
    }) => void)) => any) | undefined;
}, {}, {}>;
