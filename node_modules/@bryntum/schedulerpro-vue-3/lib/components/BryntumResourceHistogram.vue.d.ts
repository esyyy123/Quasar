import type { AjaxStore, AjaxStoreConfig, CellCopyPaste, CellCopyPasteConfig, CellEdit, CellEditConfig, CellMenu, CellMenuConfig, CellTooltip, CellTooltipConfig, Column, ColumnAutoWidth, ColumnAutoWidthConfig, ColumnDragToolbar, ColumnDragToolbarConfig, ColumnLines, ColumnLinesConfig, ColumnPicker, ColumnPickerConfig, ColumnRename, ColumnRenameConfig, ColumnReorder, ColumnReorderConfig, ColumnResize, ColumnResizeConfig, ColumnStore, ColumnStoreConfig, ContainerItemConfig, CrudManager, CrudManagerConfig, DomConfig, Editor, FileDrop, FileDropConfig, FillHandle, FillHandleConfig, Filter, FilterBar, FilterBarConfig, FilterConfig, Grid, GridBase, GridColumnConfig, GridExcelExporter, GridExcelExporterConfig, GridLocation, GridLockRows, GridLockRowsConfig, GridPdfExport, GridPdfExportConfig, GridPrint, GridPrintConfig, GridRowResize, GridRowResizeConfig, GridSelectionMode, Group, GroupConfig, GroupSummary, GroupSummaryConfig, HeaderMenu, HeaderMenuConfig, HeaderZoom, HeaderZoomConfig, Histogram, HistogramConfig, HistogramSeries, Mask, MaskConfig, Menu, MenuItem, MenuItemConfig, MergeCells, MergeCellsConfig, Model, ModelConfig, NonWorkingTime, NonWorkingTimeConfig, PagingToolbarConfig, Pan, PanConfig, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, PreserveScrollOptions, ProjectModel, ProjectModelConfig, QuickFind, QuickFindConfig, RegionResize, RegionResizeConfig, ResourceAllocationInterval, ResourceHistogramListeners, ResourceHistogramRenderData, ResourceMarginConfig, ResourceMenu, ResourceMenuConfig, ResourceModel, ResourceNonWorkingTime, ResourceNonWorkingTimeConfig, ResourceTimeRangeModel, ResourceTimeRangeModelConfig, ResourceTimeRangeStore, ResourceTimeRangeStoreConfig, ResourceTimeRanges, ResourceTimeRangesConfig, RowCopyPaste, RowCopyPasteConfig, RowExpander, RowExpanderConfig, RowReorder, RowReorderConfig, ScaleColumnConfig, ScalePoint, ScheduleTooltip, ScheduleTooltipConfig, Scheduler, SchedulerPro, SchedulerResourceModel, ScrollManager, ScrollManagerConfig, Scroller, ScrollerConfig, Search, SearchConfig, Sort, SortConfig, Split, SplitConfig, StateProvider, StickyCells, StickyCellsConfig, Store, StoreConfig, Stripe, StripeConfig, SubGrid, SubGridConfig, Summary, SummaryConfig, TabConfig, TimeAxis, TimeAxisColumn, TimeAxisConfig, TimeAxisHeaderMenu, TimeAxisHeaderMenuConfig, TimeRanges, TimeRangesConfig, TimeSpan, TimeSpanConfig, TimeSpanHighlight, TimeSpanHighlightConfig, TimelineBase, TimelineContext, Tool, ToolConfig, ToolbarConfig, Tooltip, TooltipConfig, Tree, TreeConfig, TreeGroup, TreeGroupConfig, VerticalTimeAxisColumn, ViewPresetConfig, VisibleDate, Widget } from '@bryntum/schedulerpro';
import { ResourceHistogram } from '@bryntum/schedulerpro';
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/SchedulerPro/view/ResourceHistogram#config-ariaLive)
     */
     ...
     */
    barTextEffortUnit?: string | undefined;
    /**
     ...
     * (or [effortUnit](https://bryntum.com/products/schedulerpro/docs/api/SchedulerPro/view/ResourceHistogram#config-effortUnit) to customize both texts and tooltips default units).
     */
    barTipEffortUnit?: string | undefined;
    /**
     ...
     */
    getBarClass?: ((series: HistogramSeries, domConfig: DomConfig, datum: ResourceAllocationInterval, index: number, renderData: ResourceHistogramRenderData) => string) | undefined;
    /**
     ...
     */
    getBarDOMConfig?: ((series: HistogramSeries, domConfig: DomConfig, datum: ResourceAllocationInterval, index: number, renderData: ResourceHistogramRenderData) => object) | undefined;
    /**
     ...
     */
    getBarText?: ((datum: ResourceAllocationInterval, index: number, series: HistogramSeries, renderData: ResourceHistogramRenderData) => string) | undefined;
    /**
     ...
     */
    getBarTextDOMConfig?: ((domConfig: DomConfig, datum: ResourceAllocationInterval, index: number, series: HistogramSeries, renderData: ResourceHistogramRenderData) => object) | undefined;
    /**
     ...
     */
    getOutlineClass?: ((series: HistogramSeries, data: object[], renderData: ResourceHistogramRenderData) => string) | undefined;
    /**
     ...
     */
    getOutlineDOMConfig?: ((series: HistogramSeries, domConfig: DomConfig, data: object[], renderData: ResourceHistogramRenderData) => object) | undefined;
    /**
     ...
     */
    includeInactiveEvents?: Boolean | undefined;
    /**
     ...
     */
    listeners?: ResourceHistogramListeners | undefined;
    /**
    ...
    type?: "resourcehistogram" | undefined;
    /**
    ...
    instance: {
        value?: ResourceHistogram | undefined;
    };
    refElement: import("vue").Ref<HTMLDivElement | undefined>;
    teleports: import("vue").Ref<Map<any, any>>;
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, {
    resourceNonWorkingTimeDblClick: (params: any) => void;
    resourceNonWorkingTimeMouseDown: (params: string | ((event: {
        source: SchedulerPro;
    ...
    resourceNonWorkingTimeMouseOut: (params: string | ((event: {
        source: SchedulerPro;
        feature: ResourceNonWorkingTime;
        resourceTimeRangeRecord: ResourceTimeRangeModel;
        resourceRecord: SchedulerResourceModel;
    ...
    resourceNonWorkingTimeMouseOver: (params: string | ((event: {
        source: SchedulerPro;
        feature: ResourceNonWorkingTime;
        resourceTimeRangeRecord: ResourceTimeRangeModel;
        resourceRecord: SchedulerResourceModel;
    ...
    resourceNonWorkingTimeMouseUp: (params: string | ((event: {
        source: SchedulerPro;
        feature: ResourceNonWorkingTime;
        resourceTimeRangeRecord: ResourceTimeRangeModel;
        resourceRecord: SchedulerResourceModel;
    ...
    onResourceNonWorkingTimeDblClick?: ((params: any) => any) | undefined;
    onResourceNonWorkingTimeMouseDown?: ((params: string | ((event: {
        source: SchedulerPro;
        feature: ResourceNonWorkingTime;
        resourceTimeRangeRecord: ResourceTimeRangeModel;
        resourceRecord: SchedulerResourceModel;
    ...
    onResourceNonWorkingTimeMouseOut?: ((params: string | ((event: {
        source: SchedulerPro;
        feature: ResourceNonWorkingTime;
        resourceTimeRangeRecord: ResourceTimeRangeModel;
        resourceRecord: SchedulerResourceModel;
    ...
    onResourceNonWorkingTimeMouseOver?: ((params: string | ((event: {
        source: SchedulerPro;
        feature: ResourceNonWorkingTime;
        resourceTimeRangeRecord: ResourceTimeRangeModel;
        resourceRecord: SchedulerResourceModel;
    ...
    onResourceNonWorkingTimeMouseUp?: ((params: string | ((event: {
        source: SchedulerPro;
        feature: ResourceNonWorkingTime;
        resourceTimeRangeRecord: ResourceTimeRangeModel;
        resourceRecord: SchedulerResourceModel;
