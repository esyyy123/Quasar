import type { AjaxStore, AjaxStoreConfig, AssignmentAllocationInterval, CellCopyPaste, CellCopyPasteConfig, CellEdit, CellEditConfig, CellMenu, CellMenuConfig, CellTooltip, CellTooltipConfig, Column, ColumnAutoWidth, ColumnAutoWidthConfig, ColumnDragToolbar, ColumnDragToolbarConfig, ColumnLines, ColumnLinesConfig, ColumnPicker, ColumnPickerConfig, ColumnRename, ColumnRenameConfig, ColumnReorder, ColumnReorderConfig, ColumnResize, ColumnResizeConfig, ColumnStore, ColumnStoreConfig, ContainerItemConfig, DomConfig, Editor, FileDrop, FileDropConfig, FillHandle, FillHandleConfig, Filter, FilterBar, FilterBarConfig, FilterConfig, Grid, GridBase, GridColumnConfig, GridExcelExporter, GridExcelExporterConfig, GridLocation, GridLockRows, GridLockRowsConfig, GridPdfExport, GridPdfExportConfig, GridPrint, GridPrintConfig, GridRowResize, GridRowResizeConfig, GridSelectionMode, Group, GroupConfig, GroupSummary, GroupSummaryConfig, HeaderMenu, HeaderMenuConfig, HeaderZoom, HeaderZoomConfig, Histogram, HistogramConfig, HistogramSeries, Mask, MaskConfig, Menu, MenuItem, MenuItemConfig, MergeCells, MergeCellsConfig, Model, NonWorkingTime, NonWorkingTimeConfig, PagingToolbarConfig, Pan, PanConfig, PanelCollapserConfig, PanelCollapserOverlayConfig, PanelHeader, PreserveScrollOptions, ProjectModel, ProjectModelConfig, QuickFind, QuickFindConfig, RegionResize, RegionResizeConfig, ResourceAllocationInterval, ResourceHistogramRenderData, ResourceMarginConfig, ResourceMenu, ResourceMenuConfig, ResourceNonWorkingTime, ResourceNonWorkingTimeConfig, ResourceTimeRangeModel, ResourceTimeRangeModelConfig, ResourceTimeRangeStore, ResourceTimeRangeStoreConfig, ResourceTimeRanges, ResourceTimeRangesConfig, ResourceUtilizationListeners, ResourceUtilizationModel, ResourceUtilizationRenderData, RowCopyPaste, RowCopyPasteConfig, RowExpander, RowExpanderConfig, RowReorder, RowReorderConfig, ScaleColumnConfig, ScalePoint, ScheduleTooltip, ScheduleTooltipConfig, Scheduler, SchedulerPro, SchedulerResourceModel, ScrollManager, ScrollManagerConfig, Scroller, ScrollerConfig, Search, SearchConfig, Sort, SortConfig, Split, SplitConfig, StateProvider, StickyCells, StickyCellsConfig, Store, StoreConfig, Stripe, StripeConfig, SubGrid, SubGridConfig, Summary, SummaryConfig, TabConfig, TimeAxis, TimeAxisColumn, TimeAxisConfig, TimeAxisHeaderMenu, TimeAxisHeaderMenuConfig, TimeRanges, TimeRangesConfig, TimeSpan, TimeSpanConfig, TimeSpanHighlight, TimeSpanHighlightConfig, TimelineBase, TimelineContext, Tool, ToolConfig, ToolbarConfig, TooltipConfig, Tree, TreeConfig, TreeGroup, TreeGroupConfig, VerticalTimeAxisColumn, ViewPresetConfig, VisibleDate, Widget } from '@bryntum/schedulerpro';
...
declare const _default: import("vue").DefineComponent<__VLS_TypePropsToRuntimeProps<{
     ...
     * ...
     * [View online docs...](https://bryntum.com/products/schedulerpro/docs/api/SchedulerPro/view/ResourceUtilization#config-ariaLive)
     */
     ...
     */
    getBarClass?: ((series: HistogramSeries, domConfig: DomConfig, datum: ResourceAllocationInterval | AssignmentAllocationInterval, index: number, renderData: ResourceUtilizationRenderData) => string) | undefined;
    /**
     ...
     */
    getBarDOMConfig?: ((series: HistogramSeries, domConfig: DomConfig, datum: ResourceAllocationInterval | AssignmentAllocationInterval, index: number, renderData: ResourceUtilizationRenderData) => object) | undefined;
    /**
     ...
     */
    getBarText?: ((datum: ResourceAllocationInterval | AssignmentAllocationInterval, index: number) => string) | undefined;
    /**
     ...
     */
    getBarTextDOMConfig?: ((domConfig: DomConfig, datum: ResourceAllocationInterval | AssignmentAllocationInterval, index: number, series: HistogramSeries, renderData: ResourceUtilizationRenderData) => object) | undefined;
    /**
     ...
     */
    listeners?: ResourceUtilizationListeners | undefined;
    /**
    ...
    type?: "resourceutilization" | undefined;
    /**
    ...
    instance: {
        value?: ResourceUtilization | undefined;
    };
