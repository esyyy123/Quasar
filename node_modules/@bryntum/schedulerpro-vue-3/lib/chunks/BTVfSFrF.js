import { defineComponent as h, ref as u, provide as F, onMounted as M, getCurrentInstance as D, toRaw as b, onBeforeUnmount as w, openBlock as a, createElementBlock as g, createElementVNode as T, Fragment as S, renderList as x, createBlock as c, Teleport as k, resolveDynamicComponent as E, mergeProps as H, watch as v } from "vue";
import { ResourceHistogram as y } from "@bryntum/schedulerpro";
...
const B = {
  ...
  setup(d, { expose: m, emit: p }) {
    ...
    }, r = {}, i = u(), l = u(/* @__PURE__ */ new Map());
    return F("teleports", l), M(() => {
      const e = D();
      r.value = n.createWidget({
        me: e,
        props: f,
        emit: C,
        widgetData: s,
        ...
        toRaw: b
      }), n.relayStores(e.data, r.value);
      const t = (o, R) => v(() => e.props[o], R);
      n.watchProps(r.value, s, t);
    }), w(() => {
      var e, t;
      (t = (e = r.value) == null ? void 0 : e.destroy) == null || t.call(e);
    }), m({
      instance: r,
      refElement: i,
      teleports: l
      ...
      T("div", B, [
        (a(!0), g(S, null, x(l.value.values(), (o) => (a(), c(k, {
          key: o.key,
          to: o.to
        }, [
          (a(), c(E(o.is), H({
...
//# sourceMappingURL=BTVfSFrF.js.map
