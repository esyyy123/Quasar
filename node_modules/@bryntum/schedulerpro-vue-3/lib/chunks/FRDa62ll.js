import { defineComponent as g, ref as r, provide as y, onMounted as b, getCurrentInstance as f, toRaw as k, onBeforeUnmount as S, openBlock as x, createElementBlock as O, watch as v } from "vue";
import { DependencyTypePicker as T } from "@bryntum/schedulerpro";
import { WrapperHelper as o } from "../helper/WrapperHelper.js";
const E = /* @__PURE__ */ g({
  __name: "BryntumDependencyTypePicker",
  props: {
    adopt: {},
    align: {},
    alignSelf: {},
  ...
  setup(c, { expose: s, emit: p }) {
    ...
    }, i = {}, n = r(), l = r(/* @__PURE__ */ new Map());
    return y("teleports", l), b(() => {
      const e = f();
      i.value = o.createWidget({
        me: e,
        props: d,
        emit: h,
        widgetData: a,
      ...
      const t = (m, u) => v(() => e.props[m], u);
      o.watchProps(i.value, a, t);
    }), S(() => {
      var e, t;
...
//# sourceMappingURL=FRDa62ll.js.map
