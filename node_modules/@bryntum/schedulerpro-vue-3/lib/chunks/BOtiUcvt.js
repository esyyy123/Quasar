...
const T = {
  ...
  setup(p, { expose: g, emit: f }) {
    ...
    return R("teleports", i), h(() => {
      ...
      E("div", T, [
        (n(!0), u(M, null, x(i.value.values(), (o) => (n(), c(k, {
          key: o.key,
          to: o.to
        }, [
          (n(), c(y(o.is), v({
...
//# sourceMappingURL=BOtiUcvt.js.map
