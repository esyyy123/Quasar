import { defineComponent as C, ref as l, provide as v, onMounted as f, getCurrentInstance as h, toRaw as D, onBeforeUnmount as S, openBlock as E, createElementBlock as R, watch as b } from "vue";
import { Timeline as M } from "@bryntum/schedulerpro";
import { WrapperHelper as i } from "../helper/WrapperHelper.js";
const x = /* @__PURE__ */ C({
  __name: "BryntumTimeline",
  props: {
    adopt: {},
    alignSelf: {},
    allowCreate: {},
  ...
  setup(s, { expose: d, emit: c }) {
    ...
    }, o = {}, t = l(), a = l(/* @__PURE__ */ new Map());
    return v("teleports", a), f(() => {
      const e = h();
      o.value = i.createWidget({
        me: e,
        props: u,
        emit: g,
        widgetData: r,
      ...
      const n = (p, m) => b(() => e.props[p], m);
      i.watchProps(o.value, r, n);
    }), S(() => {
      var e, n;
...
//# sourceMappingURL=BUVHJ9HA.js.map
