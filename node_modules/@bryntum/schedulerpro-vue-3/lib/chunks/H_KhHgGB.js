import { defineComponent as h, ref as u, provide as D, onMounted as F, getCurrentInstance as b, toRaw as w, onBeforeUnmount as M, openBlock as a, createElementBlock as d, createElementVNode as S, Fragment as x, renderList as T, createBlock as g, Teleport as E, resolveDynamicComponent as H, mergeProps as k, watch as v } from "vue";
import { TimelineHistogram as y } from "@bryntum/schedulerpro";
...
const B = {
  ...
  setup(c, { expose: m, emit: p }) {
    ...
    }, r = {}, l = u(), i = u(/* @__PURE__ */ new Map());
    return D("teleports", i), F(() => {
      const e = b();
      ...
      S("div", B, [
        (a(!0), d(x, null, T(i.value.values(), (o) => (a(), g(E, {
          key: o.key,
          to: o.to
        }, [
          (a(), g(H(o.is), k({
...
//# sourceMappingURL=H_KhHgGB.js.map
